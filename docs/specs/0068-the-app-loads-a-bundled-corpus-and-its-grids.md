...
there is no coverage rather than crash — that is the state SPEC 0066 already
...
- **Ship the fixture corpus as the bundled asset so the app answers now.**
  Rejected again, for the reason SPEC 0066 gave: the fixture is synthetic and
...
- Does NOT include:
  ...
  - Acting on the staleness SPEC 0067 reports.
