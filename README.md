...
- [ ] Add a contract test asserting the label list agrees across the two languages — #116 closed the Dart side, but nothing checks it against `ml/config.yaml`, and the Python test fixtures each carry their own literal
